...
export async function PUT(
  ...
  try {
    ...
    if (
      !['BROUILLON', 'COMPLEMENT_DEMANDE']
        .includes(candidature.statut)
    ) {
      return NextResponse.json(
        {
    ...
    const allowedData = {
      ...
      ville: body.ville,
      dernierDiplome: body.dernierDiplome,
      etablissement: body.etablissement,
      anneeObtention: body.anneeObtention,
      mention: body.mention,
      autresFormations: body.autresFormations,
